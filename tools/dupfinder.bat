...
set SOLUTION_NAME=kata-rabbitmq
dupfinder --exclude="%SOLUTION_NAME%\obj\**" --discard-cost=50 --discard-literals=true --show-text --o=dupfinder-report.xml --caches-home=c:\temp\dupfinder-cache "%SOLUTION_NAME%.sln"
